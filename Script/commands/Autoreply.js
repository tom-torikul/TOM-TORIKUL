...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ TOM-TORIKUL☜\nFacebook: https://https://www.facebook.com/atharislamusaidWhatsApp: +8801819528897",
    "admin": "He is TORIKUL তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস তরিকুল রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস তরিকুল এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌TOM-TORIKUL 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
